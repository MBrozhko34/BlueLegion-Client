...
public class GameLost implements Screen {
	...
	private Texture img;
	private Texture myTexture, gameLost;
	...
	public void getGameLost() {
		((Game) Gdx.app.getApplicationListener()).setScreen(new GameLost(game));;
	}
...
//		batch = new SpriteBatch();
		...
		gameLost = new Texture(Gdx.files.internal("graveGameLost.png")); // GameLost image
	...
	public void render(float delta) {
		...
		//batch.draw(GameLost, Gdx.graphics.getWidth() - 850, 150);
		batch.draw(gameLost, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
