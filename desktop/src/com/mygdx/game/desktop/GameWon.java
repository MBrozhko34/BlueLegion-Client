...
public class GameWon implements Screen {
	...
	private Texture img;
	private Texture myTexture, gameWon;
	...
	public void getGameWon() {
		((Game) Gdx.app.getApplicationListener()).setScreen(new GameWon(game));;
	}
...
//		batch = new SpriteBatch();
		...
		gameWon = new Texture(Gdx.files.internal("graveGameWon.png")); // gameWon image
	...
	public void render(float delta) {
		...
		//batch.draw(gameWon, Gdx.graphics.getWidth() - 850, 150);
		batch.draw(gameWon, 0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
